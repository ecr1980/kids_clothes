...
ActiveRecord::Schema[7.0].define(version: 2022_11_29_170201) do
  ...
  create_table "children", force: :cascade do |t|
    ...
    t.integer "dress_pants_need"
    t.integer "dress_pants_size"
    t.integer "sweatpants_need"
    t.integer "sweatpants_size"
    t.integer "leggings_need"
    t.integer "leggings_size"
    t.integer "low_cut_socks_need"
    t.integer "low_cut_socks_size"
    t.integer "high_cut_socks_need"
    t.integer "high_cut_socks_size"
    t.integer "boys_underwear_need"
    t.integer "boys_underwear_size"
    t.integer "girls_underwear_need"
    t.integer "girls_underwear_size"
    t.integer "sandals_need"
    t.integer "sandals_size"
    t.integer "flip_flops_need"
    t.integer "flip_flops_size"
    t.integer "hoodie_need"
    t.integer "hoodie_size"
    t.integer "rain_boots_need"
    t.integer "rain_boots_size"
    t.integer "boots_need"
    t.integer "boots_size"
    t.integer "snow_boots_need"
    t.integer "snow_boots_size"
    t.integer "sweater_need"
    t.integer "sweater_size"
    t.integer "sweatshirt_need"
    t.integer "sweatshirt_size"
  end
